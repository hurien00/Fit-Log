...
export default function Navbar({ planCount, savedCount }: NavbarProps) {
  ...
  //  Live count data is being retrieved from the context.
  const { todayPlan, savedPlan } = usePlan();

  // If props are passed, it will display that value; otherwise, it will directly show the dynamic count from the context
